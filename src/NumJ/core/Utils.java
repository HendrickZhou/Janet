...
public class Utils
{
	...
	*
	**/
	protected static int[] deepCopyIntArray(int[] arr)
	{
	...
	protected static byte[] deepCopyByteArray(byte[] arr)
	{
	...
	*/
	...
	protected static byte[] concatBytesArr(ArrayList<byte[]> arrays)
	{
        int length = 0;
        for (byte[] array : arrays) {
            length += array.length;
	...
	*/
	...
	protected static ArrayList<int[]> getAllIdxs(NDArray ndarr)
	{
